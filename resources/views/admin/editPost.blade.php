            ...
            <div class="col-lg-6 col-sm-10">
                <div class="row  my-3">
                    ...
                    <div class="form-group col-lg-6 col-sm-10 ">
                        ...
                        <input type="text" placeholder="عنوان فارسی پست" class="form-control " name="title_fa" value="{{$post->title_fa}}">
                        ...
                        <select class="form-select" name="category_id" aria-label="Default select example">
                            ...
                            @foreach ($categories as $category)
                                <option @if ($category['id']==$post['category_id'])
                                    {{'selected'}}
                                @endif value="{{ $category['id'] }}">{{ $category['name_' . $app->getLocale()] }}</option>
                            @endforeach
            ...
            <div class="col-lg-6 col-sm-10">
                ...
                <div class="row my-3">
                    ...
                    <div class="form-group col-lg-12 col-sm-12 text-start">
                        ...
                        <input type="text" name="title_en" placeholder="english title" class="form-control " value="{{$post['title_en']}}">
                ...
                <div class="form-group">
                    ...
                    <textarea id="editor2" cols="30" name="text_en" rows="10" class="form-control" placeholder="english post text">{{$post['text_en']}}</textarea>
                    <script>
