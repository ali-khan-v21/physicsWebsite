...
<article>
    ...
    <h1>در دست تعمیر</h1>
    <div>
        <p>با عرض پوزش  در حال حاضر در حال اجرای تعمیرات مورد نیاز وبسایت هستیم .در صورت نیاز میتوانید با تیم IT تماس بگیرید.</p>
        <p>  [WEBSITE NAME] انجمن تیم پشتیبانی  </p>
    </div>
</article>