    ...
    < <section id="hero" class="min-vh-100 d-flex align-items-center text-center">
        ...
        <section id="cognitive_neuroscience" class="section-padding border-top">
            ...
            <div class="row jostify-content-between align-items-center mx-auto">
                ...
                <div class="text-center pt-5">
                    <a href="/subject/cognitive_neuroscience" class="btn btn-secondary mx-auto p-2 fw-semibold "><h5 class="text-white">{{__("public.more")}}</h5></a>
                </div>
        ...
        <section id="neurophilosophy" class="section-padding border-top">
            ...
            <div class="row jostify-content-between align-items-center mx-auto">
                ...
                <div class="text-center pt-5">
                    <a href="/subject/neurophilosophy" class="btn btn-secondary mx-auto p-2 fw-semibold "><h5 class="text-white">{{__("public.more")}}</h5></a>
        ...
        <section id="beginner_tutorials" class="section-padding border-top">
            ...
            <div class="row jostify-content-between align-items-center mx-auto">
                ...
                <div class="text-center pt-5">
                    <a href="/subject/beginner_tutorials" class="btn btn-secondary mx-auto p-2 fw-semibold "><h5 class="text-white">{{__("public.more")}}</h5></a>
        ...
        <section id="news" class="section-padding border-top">
            ...
            <div class="row jostify-content-between align-items-center mx-auto">
                ...
                <div class="text-center pt-5">
                    <a href="/subject/news" class="btn btn-secondary mx-auto p-2 fw-semibold "><h5 class="text-white">{{__("public.more")}}</h5></a>
